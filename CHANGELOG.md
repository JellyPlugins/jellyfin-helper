...
### Tests
- Total: **4216 tests** (+1855 vs. v2.1.0.6). New test classes: `ResponseDtoTests` (63 tests covering all 17 typed response DTOs — defaults, round-trip, null-safety, collection defaults).
