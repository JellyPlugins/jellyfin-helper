/** * Behavioural filesystem tests for the cleanup stages - the "does it delete the * RIGHT thing and keep the WRONG thing" proof the counter-only tests can't give. */
