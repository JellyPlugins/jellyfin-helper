...
/// <summary>
///     Static transformation callbacks invoked by the File Transformation plugin. These methods receive the current file content and return the transformed version.
/// </summary>
public static class TransformationPatches
{
    /// <summary>
    ///     Transforms Jellyfin's index.html to include the Discovery sidebar script tag. Called by the File Transformation plugin whenever index.html is served.
    /// </summary>
