...
/// <summary>
///     A single record of a config setter clamping an out-of-range value. Surfaced by the Plugin startup path so admins who hand-edit the XML see immediately when a value was narrowed to the accepted range.
/// </summary>
