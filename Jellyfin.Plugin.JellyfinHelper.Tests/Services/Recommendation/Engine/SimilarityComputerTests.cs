...
public sealed class SimilarityComputerTests
{
    ...
    // These tests are omitted in the 2.2.0.0 / 10.11.x branch — GetPeopleNamesByItems
    // does not exist in Jellyfin 10.11.x; the code always uses the per-item fallback path.
